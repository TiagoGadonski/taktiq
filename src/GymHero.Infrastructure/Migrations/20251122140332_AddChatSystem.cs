...
namespace GymHero.Infrastructure.Migrations
{
    ...
    public partial class AddChatSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_Participant1LastMessage",
                table: "Conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_Participant2LastMessage",
                table: "Conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ConversationRead",
                table: "Messages",
                columns: new[] { "ConversationId", "ReadAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Messages_ConversationSent",
                table: "Messages",
